...
--
-- Хост: localhost
-- Время создания: Ноя 01 2022 г., 07:15
...
INSERT INTO `product` (`id_product`, `name_product`, `price_product`, `discount_price_product`, `price_promo_product`, `description`, `count_product`) VALUES
(1, 'Брюки спортивные', 3102, 2320, 2000, 'Описание: Брюки спортивные', 0),
(2, 'Брюки SMART', 3999, 2999, 2599, 'Описание: Брюки SMART', 0),
(3, 'Ботинки полнота F', 7450, 6899, 6000, 'Описание: Ботинки полнота F', 1),
(4, 'Ботинки мужски\r\n', 10990, 9490, 9000, 'Описание: Ботинки мужски', 1),
(5, 'Ботинки трекинговые', 10990, 10500, 10000, 'Описание: Ботинки трекинговые', 1),
(6, 'Кроссовки ECCO EXOSTRIDE', 5522, 4500, 4320, 'Описание: Кроссовки ECCO EXOSTRIDE', 1),
(7, 'Кроссовки LITE RACER 2.0', 11990, 11390, 6834, 'Описание: Кроссовки LITE RACER 2.0', 0),
(8, 'Кроссовки Voyage Nitro GTX', 11590, 9850, 9000, 'Описание: Кроссовки Voyage Nitro GTX', 1),
(11, 'Wanngo Сандалии\r\n', 8700, 7220, 6500, 'Описание: Wanngo Сандалии', 1),
(12, 'Leon Medikal\r\nСандалии', 9300, 8580, 7000, 'Описание: Leon Medikal Сандалии', 1),
(13, 'Alessio Nesca\r\nСандалии', 9990, 6490, 5400, 'Описание: Alessio Nesca Сандалии', 1),
(14, 'Lamoda\r\nЗонт складной', 1100, 1000, 800, 'Описание: Lamoda Зонт складной', 0),
(15, 'VOGUE\r\nЗонт-трость', 4667, 4227, 3962, 'Описание: VOGUE Зонт-трость', 0),
(16, 'Lamberti\r\nЗонт-трость', 2075, 1901, 1501, 'Описание: Lamberti Зонт-трость', 1),
(17, 'Fabretti\r\nЗонт складной', 6499, 3490, 2989, 'Описание: Fabretti Зонт складной', 0),
(18, 'Matrix\r\nОчки солнцезащитные', 2770, 1485, 1000, 'Описание: Matrix Очки солнцезащитные', 1),
...
(20, 'Ray-Ban®\r\nОчки солнцезащитные ROUND METAL ', 16100, 13100, 11000, 'Описание: Ray-Ban® Очки солнцезащитные ROUND METAL', 1),
(21, 'Armani Exchange\r\nОчки солнцезащитные AX4112SU 818180\r\n', 6125, 4620, 4000, 'Описание: Armani Exchange Очки солнцезащитные AX4112SU 818180', 1),
(22, 'Stenser\r\nГалстук\r\n', 2490, 1490, 1000, 'Описание: Stenser Галстук', 1),
(23, 'Hugo\r\nГалстук', 670, 600, 500, 'Описание: Hugo Галстук', 1),
(24, 'Stilmark\r\nГалстук', 999, 875, 785, 'Описание: Stilmark Галстук', 1),
(25, 'Henderson\r\nГалстук TS-2455', 599, 500, 455, 'Описание: Henderson Галстук TS-2455', 1),
(26, 'UYN\r\nМаска для лица защитная COMMUNITY MASK WINTER\r\n', 1599, 1299, 1200, 'Описание: UYN Маска для лица защитная COMMUNITY MASK WINTER', 1),
(27, 'adidas Originals\r\nМаски для лица защитные 3 шт. ICY PARK от adidas X IVY PARK\r\n', 499, 450, 400, 'Описание: adidas Originals\r\nМаски для лица защитные 3 шт. ICY PARK от adidas X IVY PARK', 1),
(28, 'UYN\r\nМаска для лица защитная COMMUNIT', 865, 800, 701, 'Описание: UYN\r\nМаска для лица защитная COMMUNIT', 1),
(29, 'Polo Ralph Lauren\r\nМаска для лица защитная\r\n', 1399, 1200, 1000, 'Описание: Polo Ralph Lauren\r\nМаска для лица защитная', 1),
(30, 'Finn Flare\r\nСвитер', 2999, 2599, 2000, 'Описание: Finn Flare Свитер', 1),
(31, 'DeFacto\r\nСвитер', 4999, 3999, 2599, 'Описание: DeFacto Свитер', 1);
